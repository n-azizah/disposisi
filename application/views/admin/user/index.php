...
<a href="<?php echo site_url('admin/user/add') ?>"><i cla ss="fas fa-plus"></i> Add New</a>
            </div>
...
foreach ($user as $user) {
                    echo "<tr>
                            ...
                            <td>$user->role</td>
                            <td> <div>
                            <a href=".base_url('admin/user/getedit/' . $user->id)." class='btn btn-sm btn-info'><i class='fas fa-edit'></i> Edit</
a>
